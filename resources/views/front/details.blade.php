...
<body class="text-black font-poppins pt-10 pb-[50px]">
    {{-- Some developer having issue with background image, so there is 2 option using like this on class --}}
    {{-- bg-[url('assets/background/Hero-Banner.png')] --}}
    {{-- or add inside style with background-image --}}
