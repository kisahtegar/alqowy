...
<body class="text-black font-poppins pt-10">
    <div style="background-image: url('{{asset('assets/background/Hero-Banner.png')}}');" id="checkout-section" class="max-w-[1200px] mx-auto w-full min-h-[calc(100vh-40px)] flex flex-col gap-[30px] bg-center bg-no-repeat bg-cover rounded-t-[32px] overflow-hidden relative pb-6">
